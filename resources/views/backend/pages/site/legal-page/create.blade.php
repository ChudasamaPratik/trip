...
@section('content')
    <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form method="POST" action="{{ route('legal-page.store') }}" id="legalPageForm">
                @csrf
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <select class="form-control @error('type') is-invalid @enderror" name="type">
                            ...
                            <option value="privacy_policy" {{ old('type') == 'privacy_policy' ? 'selected' : '' }}>Privacy
                                Policy</option>
                            <option value="terms_of_use" {{ old('type') == 'terms_of_use' ? 'selected' : '' }}>Terms of Use
                            </option>
                        </select>
                        @error('type')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('title') is-invalid @enderror" name="title" type="text"
                            placeholder="Enter legal page title" value="{{ old('title') }}" />
                        @error('title')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <textarea id="description" class="form-control summernote @error('description') is-invalid @enderror" name="description"
                            placeholder="Enter legal page description" rows="5">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-12 col-md-10 offset-md-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="fa fa-save"></i> Save Legal Page
                        </button>
                    </div>
                </div>
            </form>
