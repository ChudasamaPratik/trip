...
@section('content')
    <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form method="POST" action="{{ route('slider.store') }}" enctype="multipart/form-data" id="sliderForm">
                @csrf
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('title') is-invalid @enderror" name="title" type="text"
                            placeholder="Enter slider title" value="{{ old('title') }}" />
                        @error('title')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        ...
                        <div class="mt-3" id="imagePreviewContainer" style="display: none;">
                            <img id="imagePreview" src="#" alt="Slider Preview" class="img-thumbnail"
        ...
        $(document).ready(function() {
            ...
            $("#sliderForm").validate({
                ...
                messages: {
                    ...
                    image: {
                        required: "Please select an image for the slider",
