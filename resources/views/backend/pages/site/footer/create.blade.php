...
@section('content')
    <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form method="POST" action="{{ route('footer.store') }}" id="footerForm">
                @csrf
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('facebook_link') is-invalid @enderror" name="facebook_link"
                            type="text" placeholder="Enter facebook link" value="{{ old('facebook_link') }}" />
                        @error('facebook_link')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('twitter_link') is-invalid @enderror" name="twitter_link"
                            type="text" placeholder="Enter twitter link" value="{{ old('twitter_link') }}" />
                        @error('twitter_link')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('instagram_link') is-invalid @enderror" name="instagram_link"
                            type="text" placeholder="Enter instagram link" value="{{ old('instagram_link') }}" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('linkedin_link') is-invalid @enderror" name="linkedin_link"
                            type="text" placeholder="Enter linkedin link" value="{{ old('linkedin_link') }}" />
                        @error('linkedin_link')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('youtube_link') is-invalid @enderror" name="youtube_link"
                            type="text" placeholder="Enter youtube link" value="{{ old('youtube_link') }}" />
                        @error('youtube_link')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('whatsapp_link') is-invalid @enderror" name="whatsapp_link"
                            type="text" placeholder="Enter whatsapp link" value="{{ old('whatsapp_link') }}" />
                        @error('whatsapp_link')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <textarea id="declaimer_description_summernote"
                            ...
                            placeholder="Enter destination description" rows="5">{{ old('declaimer_description') }}</textarea>
                        <div id="description-error" class="text-danger" style="display: none;"></div>
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">T&C Description <span
                            class="text-danger">*</span></label>
                    <div class="col-sm-12 col-md-10">
                        <textarea id="tc_description_summernote"
                            class="form-control summernote @error('t&c_description') is-invalid @enderror" name="tc_description"
                            placeholder="Enter destination description" rows="5">{{ old('t&c_description') }}</textarea>
                        <div id="description-error" class="text-danger" style="display: none;"></div>
                        @error('t&c_description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        @enderror
