    ...
    <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30">
            <div class="clearfix mb-3">
                <div class="pull-left">
                    <h4 class="text-blue h4">About Information</h4>
                </div>
            </div>
            <form method="POST" action="{{ route('about.store') }}" enctype="multipart/form-data" id="aboutForm">
                @csrf
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('main_title') is-invalid @enderror" name="main_title"
                            type="text" placeholder="Enter About title" value="{{ old('main_title') }}" />
                        @error('main_title')
