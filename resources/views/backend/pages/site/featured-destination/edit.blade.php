                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="thumbnailImage">Choose new thumbnail (optional)</label>
                        ...
                        @enderror
                        <div class="mt-3" id="thumbnailPreviewContainer" style="{{ $tipsTravel->thumbnail ? 'display: block;' : 'display: none;' }}">
                            <img id="thumbnailPreview" src="{{ $tipsTravel->thumbnail ? $tipsTravel->thumbnail_url : '#' }}" 
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="image1">Choose new image 1 (optional)</label>
                            <small class="form-text text-muted">Image Size Should Be 1900x600 PX</small>
                        </div>
                        @error('image1')
                            <div class="invalid-feedback">
                        ...
                        @enderror
                        <div class="mt-3" id="image1PreviewContainer" style="{{ $tipsTravel->image1 ? 'display: block;' : 'display: none;' }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="image2">Choose new image 2 (optional)</label>
                            <small class="form-text text-muted">Image Size Should Be 1900x600 PX</small>
                        </div>
                        @error('image2')
                            <div class="invalid-feedback">
                        ...
                        @enderror
                        <div class="mt-3" id="image2PreviewContainer" style="{{ $tipsTravel->image2 ? 'display: block;' : 'display: none;' }}">
