...
@section('content')
    <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form method="POST" action="{{ route('bid-on-travel.update', $travelSection->id) }}"
                enctype="multipart/form-data" id="aboutForm">
                @csrf
                @method('PUT')
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('main_title') is-invalid @enderror" name="main_title"
                            ...
                            value="{{ old('main_title', $travelSection->main_title) }}" />
                        @error('main_title')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('title') is-invalid @enderror" name="title" type="text"
                            placeholder="Enter About title" value="{{ old('title', $travelSection->title) }}" />
                        @error('title')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <textarea id="summernote" class="form-control summernote @error('description') is-invalid @enderror" name="description"
                            placeholder="Enter destination description" rows="5">{{ old('description', $travelSection->description) }}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        ...
                        @enderror
                        <div class="mt-3" id="imagePreviewContainer" style="{{ $travelSection->image }}">
                            <img id="imagePreview" src="{{ $travelSection->image_url }}" alt="about Preview"
                                class="img-thumbnail" style="max-height: 300px;">
                        </div>
                        @if ($travelSection->image)
                            <div class="mt-2">
                                <small class="text-muted">Current image: {{ $travelSection->image }}</small>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-12 col-md-10 offset-md-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="fa fa-save"></i> Update Bid Travel
                        </button>
                    </div>
                </div>
            </form>
        ...
        $(document).ready(function() {
            ...
            $("#aboutImage").change(function() {
                ...
                if (this.files && this.files[0]) {
                    ...
                    preview.attr('src', '{{ $travelSection->image_url }}');
                    previewContainer.show();
