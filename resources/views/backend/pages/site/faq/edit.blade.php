...
@section('content')
    <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form method="POST" action="{{ route('faq.update', $faq->id) }}" id="faqForm">
                @csrf
                @method('PUT')
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Question <span class="text-danger">*</span></label>
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('question') is-invalid @enderror" name="question" type="text"
                            placeholder="Enter FAQ question" value="{{ old('question', $faq->question) }}" />
                        @error('question')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <textarea id="answer" class="form-control summernote @error('answer') is-invalid @enderror" name="answer"
                            placeholder="Enter FAQ answer" rows="5">{{ old('answer', $faq->answer) }}</textarea>
                        @error('answer')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
