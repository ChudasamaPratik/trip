...
@section('content')
    <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form method="POST" action="{{ route('bid.update', $bid->id) }}" enctype="multipart/form-data" id="bidForm">
                @csrf
                @method('PUT')
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('title') is-invalid @enderror" name="title" type="text"
                            placeholder="Enter bid title" value="{{ old('title', $bid->title) }}" />
                        @error('title')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('price') is-invalid @enderror" name="price" type="number"
                            placeholder="Enter bid Price" value="{{ old('price', $bid->price) }}" />
                        @error('price')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('tour') is-invalid @enderror" name="tour" type="text"
                            placeholder="Enter bid Tour" value="{{ old('tour', $bid->tour) }}" />
                        @error('tour')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        ...
                        <div class="mt-3" id="imagePreviewContainer"
                            style="{{ $bid->image ? 'display: block;' : 'display: none;' }}">
                            <img id="imagePreview" src="{{ $bid->image_url }}" alt="bid Preview" class="img-thumbnail"
                                style="max-height: 300px;">
                        </div>
                        @if ($bid->image)
                            <div class="mt-2">
                                <small class="text-muted">Current image: {{ $bid->image }}</small>
                            </div>
                        @endif
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-12 col-md-10 offset-md-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="fa fa-save"></i> Update Bid
                        </button>
                    </div>
                </div>
            </form>
