...
@section('title', 'Post Your Requirement')
...
@section('content')
    <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form method="POST" action="{{ route('requirement.store') }}" enctype="multipart/form-data" id="auctionForm">
                @csrf
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('origin') is-invalid @enderror" name="origin" type="text"
                            placeholder="Enter origin location" value="{{ old('origin') }}" />
                        @error('origin')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('destination') is-invalid @enderror" name="destination"
                            type="text" placeholder="Enter destination location" value="{{ old('destination') }}" />
                        @error('destination')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('days') is-invalid @enderror" name="days" type="number"
                            placeholder="Enter number of days" value="{{ old('days') }}" />
                        @error('days')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('persons') is-invalid @enderror" name="persons" type="number"
                            placeholder="Enter number of persons" value="{{ old('persons') }}" />
                        @error('persons')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-sm-12 col-md-10">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="breakfastYes" name="breakfast" value="With Breakfast"
                                class="custom-control-input" {{ old('breakfast') == 'With Breakfast' ? 'checked' : '' }}>
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="breakfastNo" name="breakfast" value="Without Breakfast"
                                ...
                                {{ old('breakfast') == 'Without Breakfast' ? 'checked' : '' }}>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('tour') is-invalid @enderror" name="tour" type="text"
                            placeholder="Enter tour details" value="{{ old('tour') }}" />
                        @error('tour')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-12 col-md-10 offset-md-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="fa fa-save"></i> Submit Requirement
                        </button>
                    </div>
                </div>
            </form>
