            ...
            if ($request->ajax()) {
                ...
                return DataTables::of($data)
                    ...
                    ->addColumn('action', function ($row) {
                        ...
                        $actions .= '<a href="' . route('slider.edit', $row->id) . '" class="btn btn-sm btn-outline-primary mr-1"  title="Edit">
                                        <i class="bi bi-pencil"></i>
                                     </a>';
                        $actions .= '<a href="' . route('slider.delete', $row->id) . '" class="btn btn-sm btn-outline-danger delete"  title="Delete">
