        ...
        return (function () {
            var t,
                ...
                c = {
                    ...
                    remove: function (n) {
                        var s = f();
                        t || d(s);
                        if (n && 0 === e(":focus", n).length) return void g(n);
            ...
            function m(n) {
                ...
                if (
                    ...
                    return (
                        n.iconClass && l.addClass(i.toastClass).addClass(a),
                        (function () {
                            if (n.title) {
                                var e = n.title;
                                i.escapeHtml && (e = w(n.title)),
                                    c.append(e).addClass(i.titleClass),
                                    l.append(c);
                            }
                        })(),
                        (function () {
                            if (n.message) {
                                ...
                                i.escapeHtml && (e = w(n.message)),
                                    u.append(e).addClass(i.messageClass),
                                    l.append(u);
                            }
                        })(),
                        i.closeButton &&
                            (h.addClass(i.closeClass).attr("role", "button"),
                            l.prepend(h)),
                        i.progressBar &&
                            (m.addClass(i.progressClass), l.prepend(m)),
                        i.rtl && l.addClass("rtl"),
                        i.newestOnTop ? t.prepend(l) : t.append(l),
                        (function () {
                            var e = "";
                            switch (n.iconClass) {
                                case "toast-success":
                        ...
                        i.timeOut > 0 &&
                            ((r = setTimeout(T, i.timeOut)),
                            (v.maxHideTime = parseFloat(i.timeOut)),
                            (v.hideEta = new Date().getTime() + v.maxHideTime),
                            i.progressBar &&
                                (v.intervalId = setInterval(D, 10))),
                        (function () {
                            i.closeOnHover && l.hover(b, O);
                            !i.onclick && i.tapToDismiss && l.click(T);
                            i.closeButton &&
                                h &&
                                h.click(function (e) {
                                    e.stopPropagation
                ...
                function O() {
                    (i.timeOut > 0 || i.extendedTimeOut > 0) &&
                        ((r = setTimeout(T, i.extendedTimeOut)),
